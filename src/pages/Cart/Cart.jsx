              ...
              return (
                <div key={index}>
                  <div className="cart-items-title cart-items-item">
                    ...
                    <p className="text-white">${item.price * cartItems[item._id]}</p>
                    <p className="text-white cross" onClick={() => removeFromCart(item._id)}>
                      x
                    </p>
                  </div>
                  <hr />
          ...
          <div className="cart-total">
            ...
            <div>
              ...
              <div className="cart-total-details">
                ...
                <p className="text-white">${getTotalCartAmount() === 0 ? 0 : 2}</p>
              </div>
              <hr />
              <div className="cart-total-details">
